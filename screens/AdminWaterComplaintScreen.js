...
export default class AdminWaterComplaintScreen extends React.Component {
  constructor() {
    super();
    this.state = {
  ...
  renderItem = ({ item, i }) => {
    return (
      <ListItem
        key={i}
        title={item.User_id}
        subtitle={'Status: ' + item.Complaint_Status}
