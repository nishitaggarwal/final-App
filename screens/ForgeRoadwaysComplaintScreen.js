...
export default class ForgeRoadwaysComplaint extends React.Component {
  constructor() {
    super();
    this.state = {
      userId: firebase.auth().currentUser.email,
      complaint_Type: 'Roadways Complaint',
      state: '',
      area_Address: '',
...
transporter.sendMail(mailOptions, (err, data) => {
  ...
  createComplaint = () => {
    ...
    return Alert.alert(
      ...
      'Kindly check your mail Regarding the deatils of the complaint',
      [
        {
          text: 'OK',
          onPress: () => this.props.navigation.navigate('Awareness'),
        },
      ]
    );
  };
      ...
      <View style={{ height: '100%' }}>
        <SafeAreaProvider>
          ...
          <Text style={styles.headerText}>
            All Complaints are Lisited and Submitted under Central Government
          </Text>
          <TextInput
