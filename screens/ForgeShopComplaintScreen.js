...
export default class ForgeShopComplaint extends React.Component {
  constructor() {
    super();
    this.state = {
      userId: firebase.auth().currentUser.email,
      complaint_Type: 'Shop Complaint',
      state: '',
      area_Address: '',
      ...
      <View style={{ height: '100%' }}>
        <SafeAreaProvider>
          ...
          <Text style={styles.headerText}>
            All Complaints are Lisited and Submitted under Consumer Rights
          </Text>
          <TextInput
